...
//     */
//    public convenience init(gifImage:BLGif, contentMode: UIViewContentMode = .ScaleToFill, manager:SwiftyGifManager = SwiftyGifManager.defaultManager) {
//        self.init()
...
//     */
//    public convenience init(gifImage:BLGif, contentMode: UIViewContentMode = .ScaleToFill, manager:SwiftyGifManager = SwiftyGifManager.defaultManager, loopCount:Int) {
//        self.init()
...
//     - Parameter manager: The manager to handle the gif display
//     */
//    public func setGifImage(gifImage:BLGif, contentMode: UIViewContentMode = .ScaleToFill, manager:SwiftyGifManager = SwiftyGifManager.defaultManager) {
//        
//        setGifImage(gifImage, manager: manager, loopCount: -1)
//    }
//
...
//     - Parameter loopCount: The number of loops we want for this gif. -1 means infinite.
//     */
//    public func setGifImage(gifImage:BLGif, contentMode: UIViewContentMode = .ScaleToFill, manager:SwiftyGifManager = SwiftyGifManager.defaultManager, loopCount:Int) {
...
//
//            if let source = gif.imageSource, let imageT = CGImageSourceCreateImageAtIndex(source, 0, nil)  {
//                
//                self.currentImage = UIImage(CGImage: imageT)
//
...
//        if !self.haveCache {
//            if let gifImage = self.gifImage, let imageSource =  gifImage.imageSource where self.displayOrderIndex < gifImage.displayOrder!.count {
//                self.currentImage = UIImage(CGImage: CGImageSourceCreateImageAtIndex(imageSource,gifImage.displayOrder![self.displayOrderIndex],nil)!)
//            }
//        } else {
//            if let image = (cache!.objectForKey(self.displayOrderIndex) as? UIImage) {
//                self.currentImage = image
//            } else {
//                if let gifImage = self.gifImage, let  imageSrc = gifImage.imageSource,
//                    let currentCGImage = CGImageSourceCreateImageAtIndex(imageSrc,gifImage.displayOrder![self.displayOrderIndex],nil) {
//                
...
//        }
//        
//        // Remove cache CGImage
//        if let gif = self.gifImage {
//            for i in 0 ..< gif.displayOrder!.count {
//                CGImageSourceRemoveCacheAtIndex(gif.imageSource!, gif.displayOrder![i])
//            }
//        }
//        
//        self.gifImage = nil
...
//        get {
//            return (objc_getAssociatedObject(self, _gifImageKey) as! BLGif?)
//        }
//        set {
